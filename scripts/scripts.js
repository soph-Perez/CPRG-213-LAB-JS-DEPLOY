...
// INSERT YOUR CODE HERE
let modelButton = document.getElementById("model-button"); /*for switch model*/

function changeModel(){
    let spanModelButton = document.getElementById("model-text");

    if(modelName === "XYZ"){
        modelName = "CPRG";
        spanModelButton.innerHTML = "Model CPRG";
    } else if(modelName === "CPRG"){
        modelName = "XYZ";
        spanModelButton.innerHTML = "Model XYZ";
    } else {
        console.log("Not a valid model");
    }
...
function changeDuration(){
    ...
    duration = Number(newDuration); /*prompt returns a string*/
